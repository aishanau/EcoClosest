    ...
    <ScrollView>
      <View style={{ marginVertical: 20 }}>
        ...
        <View style={{ margin: 10 }}>
                  ...
                  {brandSearch == "" ? (
                    <SectionList
                      ...
                      keyExtractor={(item, index) =>
                        `basicListEntry-${item.title}-${index}`
                      }
                    />
                  ) : (
                    <FlatList
          ...
          <TouchableOpacity
            onPress={() => {
              !view && setCategoryModalVisible(!categoryModalVisible);
            }}
            disabled={view}
          >
            <View>
          ...
          <TouchableOpacity
            onPress={() => {
              !view && setColourModalVisible(!colourModalVisible);
            }}
            disabled={view}
          >
            <View>
          ...
          <TouchableOpacity
            onPress={() => {
              !view && setFabricModalVisible(!fabricModalVisible);
            }}
            disabled={view}
          >
            <View>
...
const brandsSection = [
  ...
  {
    title: "F",
    data: ["Fendi", "Foot Locker Inc.", "Forever 21", "Fossil", "Furla"],
  },
  ...
  {
    title: "M",
    data: ["Macy’s", "Manolo Blahnik", "Max Mara", "Michael Kors", "Moncler"],
  },
  {
    title: "N",
    data: [
